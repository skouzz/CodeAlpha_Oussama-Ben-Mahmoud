  ...
  return (
    <div className='border-b border-neutral-800 pb-24'>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        >
          <img className="h-auto max-w-full rounded-lg mb-10" style={{ maxWidth: '60%', height: 'auto' }} src="/src/assets/Certifications/databases.png" alt="" />
        ...
        <motion.div
          ...
          style={{ cursor: "pointer" }}
        >
          <img className="h-auto max-w-full rounded-lg mb-10" style={{ maxWidth: '60%', height: 'auto' }} src="/src/assets/Certifications/CCNA1.png" alt="" />
        ...
        <motion.div
          ...
          style={{ cursor: "pointer" }}
        >
          <img className="h-auto max-w-full rounded-lg mb-10" style={{ maxWidth: '60%', height: 'auto' }} src="/src/assets/Certifications/CCNA.png" alt="" />
